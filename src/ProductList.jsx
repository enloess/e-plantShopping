...
function ProductList() {
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                <rect width="156" height="156" fill="none">5</rect>
                            ...
                            <h6 className='cart_quantity_count'>{ getCartCount() }</h6>
                        </h1>
                    </a>
                </div>
            </div>
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        <button
                            ...
                            disabled={ addedToCart[plant.name] ? 'disabled' : ''}
    ...
    <CartItem onContinueShopping={handleContinueShopping} removeItemFromCart={handleRemoveFromCart}/>
)}
    </div>
    );
}
